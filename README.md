...
Слой rationale используется для вопросов "почему так", отклоненных подходов, причин ошибок, экспериментов и проектных инвариантов. Это не место для скрытых рассуждений агента: запись должна содержать проверяемое решение, альтернативы и evidence.
